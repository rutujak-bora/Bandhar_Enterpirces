  ...
  (function bandharProductSectionInit() {
    const productDataBandhar = {
      ...
      servers: {
        ...
        note: 'Bandhar Enterprises: High-performance GPUs, next-gen graphics cards, Intel Xeon/AMD EPYC processors, and datacenter hardware from NVIDIA, MSI, and authorized distributors.',
        subcategories: [
          { brand: 'NVIDIA Workstation & Flagship GPUs', desc: 'Flagship next-gen GPUs and enterprise workstation cards for AI computation, machine learning, visual effects, and high-performance server clusters.', types: ['NVIDIA RTX 5090 (32GB GDDR7)', 'NVIDIA RTX 5080 (16GB GDDR7)', 'NVIDIA RTX 5070', 'NVIDIA RTX 6000 Ada Generation (48GB)', 'NVIDIA RTX 5000 / 4000 Ada', 'NVIDIA A100 / H100 Tensor Core GPUs'] },
          { brand: 'MSI & Partner Graphic Cards', desc: 'Top-tier graphics cards from MSI, ASUS, and Gigabyte engineered with triple-fan thermal architecture and reinforced backplates for continuous enterprise compute.', types: ['MSI GeForce RTX 5090 Suprim / Gaming X', 'MSI RTX 5080 Ventus 3X', 'MSI RTX 5070 Gaming Trio', 'MSI RTX 4090 / 4080 Super', 'ASUS TUF / ROG & Gigabyte AORUS Editions'] },
          { brand: 'Server Processors (CPUs)', desc: 'Enterprise multi-core server processors with high cache capacity for cloud computing, virtualization, and database workloads.', types: ['Intel Xeon Scalable (Silver / Gold / Platinum)', 'AMD EPYC 9004 / 7003 Series', 'AMD Ryzen Threadripper PRO 7000WX', 'Intel Xeon E-2300 & W-Series'] },
          { brand: 'Server Motherboards & Barebones', desc: 'Single and dual-socket enterprise server boards with multi-PCIe Gen 5 lanes, IPMI remote management, and 10GbE network interfaces.', types: ['Supermicro X12 / H12 / H13 Server Boards', 'ASUS Enterprise Server Motherboards', 'Gigabyte Enterprise Series', 'Intel Server Board Family'] },
          { brand: 'RAID & SAS Host Bus Adapters', desc: 'Hardware RAID controllers, 12Gb/s SAS/SATA/NVMe host bus adapters with battery backup units (BBU) and cache protection.', types: ['Broadcom / LSI MegaRAID 9560/9460', 'Dell PERC H755 / H740P Controller', 'HPE Smart Array P408i Series', 'HighPoint NVMe RAID Cards'] },
          { brand: 'Server Power Supplies & Enclosures', desc: 'Redundant 80 PLUS Platinum & Titanium hot-swappable power supply units, server chassis kits, and high-CFM cooling fans.', types: ['Supermicro 800W/1200W/2000W Redundant PSU', 'Dell / HPE Hot-Plug Server PSUs', '1U / 2U / 4U Rackmount Chassis', 'High-CFM Server Cooling Kits'] }
        ]
      }
    };
